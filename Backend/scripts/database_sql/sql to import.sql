...
-- ============================================================================
-- 3. LOGISTIC PARTNERS & ORDER HANDOVER FIX (ADDED 2026-01-19)
-- ============================================================================
...
-- Update status ENUM to include 'with_logistic' and 'ready'
...
-- Fix payment_status: change 'completed' to 'paid' in existing records
