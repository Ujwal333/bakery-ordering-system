...
// Chatbot Routes
Route::get('/chatbot/init', [ChatbotController::class, 'getInitData']);
Route::get('/chatbot/products', [ChatbotController::class, 'getProducts']);
Route::get('/chatbot/custom-steps', [ChatbotController::class, 'getCustomCakeSteps']);

// Payment initiation
Route::post('/payment/initiate', [PaymentController::class, 'initiate']);

// Rider / Delivery Tracking API
Route::prefix('delivery')->group(function () {
    Route::post('/{delivery}/location', [DeliveryTrackingController::class, 'updateLocation']);
    Route::post('/{delivery}/start', [DeliveryTrackingController::class, 'startDelivery']);
    Route::post('/{delivery}/complete', [DeliveryTrackingController::class, 'completeDelivery']);
});
...
Route::get('/track-order', [OrderController::class, 'trackByGet']);
Route::post('/orders', [OrderController::class, 'store']);

// Protected routes (require authentication)
Route::middleware('auth:sanctum')->group(function () {
    // Auth (Moved to web.php)
